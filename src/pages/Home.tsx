      ...
      <section className="testimonials-section">
        ...
        <div className="testimonials-grid">
          <div className="testimonial-card">
            ...
            <p>"Heidi framed my grandmother's needlework beautifully. The attention to detail was incredible — every stitch was perfectly aligned. I'll never go anywhere else!"</p>
          ...
          <div className="testimonial-card">
            <div className="testimonial-stars">★★★★★</div>
            <p>"The personal appointment experience is wonderful. Heidi came to our home with samples so we could match the framing to our decor. The result was stunning!"</p>
            <div className="testimonial-author">
          ...
          <div className="testimonial-card">
            <div className="testimonial-stars">★★★★★</div>
            <p>"I've had over a dozen pieces framed here. The quality of materials and craftsmanship is leagues above the big-box stores. Worth every penny."</p>
            <div className="testimonial-author">
